...
class _AddressVerificationPageState extends State<AddressVerificationPage> {
  ...
  Future<void> _captureImage() async {
    try {
      // FIXED: Show loading dialog immediately
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Getting location & opening camera...',
...
// import 'package:exif/exif.dart'; // NEW
...
//   // ------------ NEW: Get image metadata (width, height, EXIF orientation) ------------
...
//       frame.image.dispose();
//     } catch (e) {
//       debugPrint('Failed to decode image for size: $e');
//     }
...
//         if (orientTag != null) {
//           orientation = orientTag.printable ?? orientTag.toString();
//         } else {
//           orientation = 'No EXIF Orientation';
//         }
//       } else {
//         orientation = 'No EXIF';
//       }
//     } catch (e) {
//       debugPrint('Failed to read EXIF: $e');
//       orientation = 'EXIF read error';
//     }
...
//         // ---------- NEW: metadata and debugging ----------
//         final meta = await _getImageMetadata(photo.path);

//         debugPrint("📸 IMAGE ${_capturedImages.length + 1} INFO:");
//         debugPrint("Path: ${photo.path}");
//         debugPrint("Width: ${meta['width']}");
//         debugPrint("Height: ${meta['height']}");
//         debugPrint("Orientation: ${meta['orientation']}");
//         // -------------------------------------------------
...
//                       _buildDetailRow(Icons.home, 'Address', imageData['address']),
//                       const Divider(),
//                       // NEW: width, height, orientation
//                       _buildDetailRow(Icons.image, 'Width', (imageData['width'] ?? 0).toString()),
//                       const Divider(),
//                       _buildDetailRow(Icons.image, 'Height', (imageData['height'] ?? 0).toString()),
//                       const Divider(),
//                       _buildDetailRow(Icons.screen_rotation, 'Orientation', imageData['orientation'] ?? 'Unknown'),
//                       const SizedBox(height: 16),
//                     ],
//                   ),
//                 ),
...
//       if (result != null && result.files.isNotEmpty) {
//         // ---------- NEW: If picked file is an image, read and log metadata ----------
//         final picked = result.files.first;
//         final ext = (picked.extension ?? '').toLowerCase();
//         if (ext == 'jpg' || ext == 'jpeg' || ext == 'png') {
//           try {
//             final meta = await _getImageMetadata(picked.path!);
//             debugPrint("📄 DOCUMENT IMAGE INFO:");
//             debugPrint("Path: ${picked.path}");
//             debugPrint("Width: ${meta['width']}");
//             debugPrint("Height: ${meta['height']}");
//             debugPrint("Orientation: ${meta['orientation']}");
//           } catch (e) {
//             debugPrint("Failed to read metadata for uploaded image: $e");
//           }
//         }
//         // Convert document to base64 immediately
//         String base64Doc = await _fileToBase64(result.files.first.path!);
