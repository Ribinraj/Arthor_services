...
// //     // 🔹 Fire the attributes fetch when page opens using existing bloc from context
...
// //     // Do NOT close bloc here – it's provided from above (MultiBlocProvider)
// //     super.dispose();
// //   }
...
// //                           labelText: 'Is the address traceable? *',
// //                           labelStyle:
// //                               TextStyle(color: Appcolors.kblackcolor.withOpacity(0.7)),
// //                           border: OutlineInputBorder(
// //                             borderRadius: BorderRadius.circular(12),
// //                             borderSide: const BorderSide(color: Appcolors.kbordercolor),
// //                           ),
...
// class _AddressVerificationPageState extends State<AddressVerificationPage> {
//   final _formKey = GlobalKey<FormState>();
//   final ImagePicker _picker = ImagePicker(); // (unused, but ok if you want gallery later)
...
//     // Fetch attributes when page opens
//     context.read<FetchAtributesBloc>().add(
//           FetchAtributesInitialEvent(
//             verificationTypeId: widget.verificationTypeId,
//           ),
